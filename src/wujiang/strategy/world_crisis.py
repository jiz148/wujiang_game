...
def _activate_snow_ghost_showdown(world: WorldState, crisis: WorldCrisis) -> None:
    ...
    if battle is None:
        ...
        from wujiang.strategy.heroes import active_strategic_hero_codes_for_faction
...
def resolve_world_crisis_choice(
    ...
    *,
    ...
    from wujiang.strategy.hero_personal import record_hero_crisis_choice
...
def set_world_crisis_showdown_resolution(
    ...
    *,
    ...
    if resolution_mode == "quick" and auto_resolve:
        from wujiang.strategy.battles import resolve_pending_battle
