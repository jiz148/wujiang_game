...
from wujiang.strategy.audit import append_operation_audit, sha256_text
from wujiang.strategy.backup import StrategyBackupManager, StrategyBackupRecord
...
from wujiang.strategy.models import CampaignMember, EventLogEntry, StrategyError, WorldState
        ...
        *,
        ...
        with self._lock:
            ...
            with self._connection() as connection:
                ...
                if str(row["request_type"]) == "handover":
                    from wujiang.strategy.heroes import handover_player_office
                    ...
                    from wujiang.strategy.heroes import vacate_player_office
        ...
        *,
        ...
        with self._lock:
            ...
            with self._connection() as connection:
                ...
                from wujiang.strategy.objectives import require_campaign_orders_open
