...
from wujiang.strategy.models import EventLogEntry, RelicAltar, RelicState, StrategyError, WorldState
...
def _hero_name(world: WorldState, hero_code: str) -> str:
    from wujiang.strategy.heroes import strategic_hero_pool_public
...
def release_sleeping_heroes_with_lost_relics(
    ...
    *,
    ...
    released: list[str] = []
    from wujiang.strategy.heroes import release_sleeping_hero_for_lost_relic
...
def relic_system_public(world: WorldState) -> dict[str, Any]:
    from wujiang.strategy.hero_personal import hero_command_accepts
