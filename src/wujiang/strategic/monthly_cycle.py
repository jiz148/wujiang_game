...
from wujiang.strategic.models import City, WorldState
from wujiang.strategic.rebellion import rebellion_force_troops
from wujiang.strategic.simulation import (
    POLICIES,
    _apply_policy,
...
def monthly_cycle_public(world: WorldState, queued_actions: Iterable[Any]) -> dict[str, dict[str, Any]]:
    from wujiang.strategic.story import story_events_public

    actions = [_action_dict(action) for action in queued_actions]
    output: dict[str, dict[str, Any]] = {}
    briefings = __import__("wujiang.strategic.command", fromlist=["monthly_briefings_public"]).monthly_briefings_public(world)
