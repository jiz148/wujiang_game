...
from wujiang.strategic.models import City, EventLogEntry, StrategyError, WorldState
from wujiang.strategic.objectives import record_strategic_status_events
from wujiang.strategic.rebellion import rebellion_force_troops, set_rebellion_force_troops
...
def rebellion_risk(city: City, *, food_shortage: bool = False) -> int:
    ...
    if city.policy == "征兵优先" and support < 50:
        risk += 10
    from wujiang.strategic.occupation import occupation_rebellion_modifier
...
def advance_month(world: WorldState) -> WorldState:
    ...
    from wujiang.strategic.story import advance_story_events
    ...
    from wujiang.strategic.sieges import advance_sieges
    from wujiang.strategic.relics import advance_relic_maintenance
    from wujiang.strategic.hero_personal import advance_hero_personal_states
    from wujiang.strategic.world_crisis import advance_world_crises
    ...
    from wujiang.strategic.occupation import apply_occupation_month_start, finish_occupation_month
    from wujiang.strategic.rebellion import resolve_rebellion_political_outcome
