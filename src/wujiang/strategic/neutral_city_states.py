...
from wujiang.strategic.models import EventLogEntry, Faction, StrategyError, WorldState
...
def validate_neutral_city_state_incitement(
    ...
    *,
    ...
    from wujiang.strategic.diplomacy import diplomacy_cooldown_until
...
def incite_neutral_city_state(
    ...
    *,
    ...
    from wujiang.strategic.diplomacy import record_diplomatic_memory, set_diplomacy_cooldown
