...
from wujiang.strategic.administration import REGISTERED_UNIT_TYPES
from wujiang.strategic.models import EventLogEntry, StrategicArmy, StrategicEncounter, StrategyError, WorldState
    ...
    while pending:
        ...
        for next_id in sorted(nodes_by_id[current_id].connected_node_ids):
            ...
            if blocked_route_keys:
                from wujiang.strategic.world_crisis import strategic_route_key
...
def advance_army_supply(world: WorldState) -> WorldState:
    ...
    from wujiang.strategic.sieges import reconcile_sieges
