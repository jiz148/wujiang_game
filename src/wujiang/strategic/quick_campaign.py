...
def _quick_diplomacy_recommendation(
    ...
    from wujiang.strategic.diplomacy import neutral_diplomacy_options_public
...
def _quick_military_recommendation(
    ...
    from wujiang.strategic.battles import MIN_ATTACK_TROOPS, city_attack_commitment
