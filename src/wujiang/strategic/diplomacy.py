...
from wujiang.strategic.models import DiplomaticAgreement, EventLogEntry, Faction, StrategyError, WorldState
from wujiang.strategic.neutral_city_states import adjacent_city_ids, faction_by_id
from wujiang.strategic.neutral_politics import neutral_city_state_profile
...
def apply_neutral_diplomacy_action(
    ...
    *,
    ...
    from wujiang.strategic.peaceful_integration import adjust_neutral_influence
