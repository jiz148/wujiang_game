...
export const state = {
  ...
  strategyVariants: [],
  strategyCrisisEarliestYear: 10,
  strategyYearLimit: 0,
  strategyMajorFactionCount: 2,
  ...
  strategyMessage: "",
  strategyBusy: false,
  strategyEndTurnPending: false,
  strategyMapFocusCityId: "",
  strategyOwnedCityFocusIndex: 0,
  ...
  strategyDiplomacyActionableOnly: true,
  strategyBattleNoticeId: "",
  // 武将页先给名单；详情要点开某个人才展开，避免一页塞下所有人的档案。
  strategyDockHeroCode: "",
  // 科技分类默认展开；这里记的是玩家主动收起的那些类。
  strategyTechCollapsed: {},
  strategyMapView: { x: 0, y: 0, scale: 1 },
  strategyTurnToast: null,
  strategyTurnToastTimer: 0,
  aiPreview: null,
  homeFlow: "",
  ...
  roomSetupOpen: false,
  roomSetupDraft: null,
  autoConfigureOpen: false,
  autoConfigureDraft: null,
  gameOverShowDetails: false,
  gameOverDismissed: false,
  replayTimelineDragging: false,
  strategyExpeditionHeroCodes: [],
  strategyExpeditionError: "",
