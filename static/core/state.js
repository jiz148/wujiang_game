...
export const state = {
  ...
  battleLaunch: null,
  strategyName: "英灵城邦",
  strategySeed: "18472631",
  strategyVariantId: "classic_frontier",
  strategyVariants: [],
  strategyCrisisEarliestYear: 10,
  strategyYearLimit: 0,
  strategyMajorFactionCount: 2,
  strategyCampaignMode: "true_campaign",
  strategyScenarioId: "true_world_v1",
  strategyWorldCatalog: null,
  strategyTradeTargetId: "",
  strategyTradeDirection: "sell",
  strategyTradeResourceId: "grain_dew",
  strategyTradeAmount: 10,
  strategyTradeMoney: 0,
  strategyTradeAutoMoney: true,
  strategyHeroPath: "",
  strategyHeroTargetId: "",
  strategyHeroCode: "",
  strategyHeroFactionName: "",
  ...
  strategyDockWide: false,
  strategyDockTab: "city",
  strategyEventFilter: "all",
